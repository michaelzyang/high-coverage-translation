...
There are five folders, one for each language. Each folder contains two files: 1) the shared task data (example, dev.en_hu.2020-02-20.prompts.txt) and 2) the AWS translation baseline (example, dev.en_hu.aws_baseline.pred.txt).
