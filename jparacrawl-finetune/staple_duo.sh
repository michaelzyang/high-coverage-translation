...
PRETRAINED_MODEL_FILE=$PWD/pretrained_model_enja/base.pretrain.pt

SPM_MODEL=$PWD/duolingo/enja_spm_models/spm.$TRG.nopretok.model

DATA_DIR=$PWD/duolingo/bin_splits
TEST_TRG_RAW=$PWD/duolingo/raw_splits/test-split-sents.$TRG
